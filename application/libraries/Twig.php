...
class Twig
{
	...
	private $functions_safe = [
		'form_open', 'form_close', 'form_error', 'form_hidden', 'set_value','form_open_multipart',
...
//		'set_radio',
	...
	{
		$params['functions'] = ['img_url', 'lang', 'validation_errors', 'real_base_url',
			'url_user_avatar','flashdata','get_csrf_hash', 'get_csrf_token_name',
			'validate_access_acl_to', 'count_array', 'get_user_fullname',
			'bulk_report_to_html','get_session_user_var', 'get_current_url'];
